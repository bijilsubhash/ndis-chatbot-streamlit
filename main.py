...
col2.markdown(f"""<h2>This app is an LLM powered chatbot, built with</h2> <h2><img alt="File:OpenAI Logo.svg - Wikimedia Commons" src="https://upload.wikimedia.org/wikipedia/commons/thumb/4/4d/OpenAI_Logo.svg/2560px-OpenAI_Logo.svg.png" style="font-size: 13px; width: 100px; height: 24px;"/>
